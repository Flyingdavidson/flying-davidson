    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="border-y border-white/10 bg-white/[0.03]">
        <div className="mx-auto grid max-w-7xl grid-cols-2 gap-x-6 gap-y-8 px-6 py-10 md:grid-cols-4 md:px-10">
          ...
          <AircraftStat label="Aircraft" value="Hawker Sea Fury" />
          <AircraftStat label="Type" value="Historic Warbird" />
          <AircraftStat label="Engine" value="Radial Piston" />
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 md:px-10 md:py-24">
        ...
        <div className="mt-5 grid gap-8 lg:grid-cols-[1fr_0.8fr] lg:items-end">
          ...
          <p className="max-w-xl text-base leading-7 text-white/60 md:text-lg md:leading-8">
            Designed as a high-performance naval fighter, the Sea Fury combines
            immense radial-engine power with unmistakable lines and a commanding
            presence in the air.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-20 md:px-8 md:pb-28">
        ...
        <div className="grid gap-3 md:grid-cols-2 md:gap-4">
          {gallery.map((src, index) => (
            <button
              ...
              aria-label={`Open Hawker Sea Fury image ${index + 1}`}
              className="group relative aspect-[16/10] overflow-hidden rounded-xl bg-white/5 text-left md:rounded-2xl"
            >
              <Image
                src={src}
        ...
        <div className="mt-8 border-t border-white/10 pt-6">
          <p className="text-xs uppercase leading-6 tracking-[0.25em] text-white/35">
            Hawker Sea Fury / Historic Warbird
          </p>
        </div>
      </section>
      ...
      {activeImage !== null && (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-label="Hawker Sea Fury image gallery"
        ...
        >
          ...
          >
            <Image
              ...
              alt={`Hawker Sea Fury gallery image ${activeImage + 1}`}
              fill
              priority
              sizes="100vw"
