    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="border-y border-white/10 bg-white/[0.03]">
        <div className="mx-auto max-w-7xl px-6 py-24 md:px-10">
          ...
          <div className="mt-20 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            <Spec title="Manufacturer" value="Clark" />
            <Spec title="Model" value="CTA 50" />
            <Spec title="Role" value="Aircraft Towing" />
            <Spec title="Operation" value="Hangar Support" />
          </div>
        </div>
      </section>

      <Gallery
        title="Clark CTA 50 Gallery"
      ...
      <section className="mx-auto max-w-6xl px-6 py-28 text-center">
        ...
        <p className="mx-auto mt-10 max-w-4xl text-lg leading-9 text-white/70">
          The Clark CTA 50 is an essential part of daily life in the Flying
          Davidson hangar. It is used to safely position aircraft before and
          after flight, helping the team move valuable machinery accurately
          through confined hangar and apron spaces.
        </p>

        <p className="mx-auto mt-6 max-w-4xl text-lg leading-9 text-white/70">
          It may not leave the ground, but its role is critical. Dependable,
          practical and always ready for work, the Clark is one of the
          hardest-working machines in the operation.
        </p>
      </section>
