...
const partners = ["Red Bull", "Emotive", "Team 77"];
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-10 grid gap-px overflow-hidden border border-white/10 bg-white/10 md:grid-cols-3">
            {partners.map((partner) => (
              <div
                key={partner}
                className="bg-black px-8 py-12 text-center text-2xl font-black uppercase tracking-[0.15em] text-white/75"
              >
                {partner}
              </div>
            ))}
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
            ...
            >
              ...
              <p className="mt-5 text-sm leading-7 text-white/55">
                Access Patrick&apos;s full media resources and official downloads.
              </p>
            ...
            >
              ...
              <p className="mt-5 text-sm leading-7 text-white/55">
                Download the approved printable version of Patrick&apos;s biography.
              </p>
              <p className="mt-8 text-xs uppercase tracking-[0.3em] text-yellow-400">
                Download ↓
              </p>
            ...
            >
              ...
              <p className="mt-5 text-sm leading-7 text-white/55">
                Approved high-resolution imagery for editorial and promotional use.
              </p>
              <p className="mt-8 text-xs uppercase tracking-[0.3em] text-yellow-400">
                Download ↓
              </p>
            ...
            >
              ...
              <p className="mt-5 text-sm leading-7 text-white/55">
                Official information for the GameBird GB1 and Edge 540 V3.
              </p>
              <p className="mt-8 text-xs uppercase tracking-[0.3em] text-yellow-400">
                Download ↓
              </p>
