...
export default function AircraftPageClient({
  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <Gallery
        title="Fuel Bowser Gallery"
        subtitle="Keeping The Fleet Moving"
        images={gallery}
      />

      {videos.length > 0 && (
        <VideoGallery
          title="Fuel Bowser Videos"
      ...
      <section className="mx-auto max-w-6xl px-6 py-28 text-center">
        ...
        <p className="mx-auto mt-10 max-w-4xl text-lg leading-9 text-white/70">
          A good flying day starts long before an engine fires. The bowser
          gives the team a practical, self-contained refuelling station that
          can be positioned where it is needed, helping aircraft move through
          pre-flight preparation without unnecessary delay.
        </p>

        <p className="mx-auto mt-6 max-w-4xl text-lg leading-9 text-white/70">
          With its pump, filtration system and delivery hose protected inside
          the rear service compartment, it is one of the quiet essentials of
          the hangar: rarely in the spotlight, but always part of getting the
          fleet safely ready for the next flight.
        </p>
      </section>
