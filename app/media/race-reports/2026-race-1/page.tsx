      ...
      <section className="relative min-h-screen overflow-hidden bg-gradient-to-br from-black via-zinc-950 to-zinc-900">
        ...
        <div className="relative z-10 flex min-h-screen items-end px-8 py-24 md:px-16 lg:px-24">
          <div className="max-w-6xl">
            ...
            <h1 className="text-3xl font-black uppercase italic leading-[0.82] md:text-6xl lg:text-9xl">
              Grounded.
              <br />
              Flooded.
              <br />
        ...
        <div className="mx-auto grid max-w-6xl gap-14 lg:grid-cols-[0.7fr_1.3fr]">
          ...
          <article className="space-y-16">
            ...
            <section className="bg-white px-8 py-14 text-black md:px-12">
              ...
              <h2 className="mt-5 text-4xl font-black uppercase italic leading-none md:text-6xl">
                Qualified 4th.
              </h2>
              <p className="mt-6 text-3xl font-black italic text-[#0b7f68] md:text-5xl">
                12 points
              </p>
