...
type Props = {
  ...
  classicGallery: string[];
  currentVideos: AircraftVideo[];
  classicVideos: AircraftVideo[];
};
...
<Spec title="Configuration" value="18-Cylinder Radial" />
      ...
      <Gallery
        ...
        subtitle="Current Paint Scheme"
        images={currentGallery}
      />

      <VideoGallery
        title="Current Videos"
        subtitle="Flight Footage"
      ...
      <section className="mx-auto max-w-6xl px-6 py-28 text-center">
        ...
        <p className="mx-auto mt-10 max-w-4xl text-lg leading-9 text-white/70">
          Before receiving her current Royal Australian Navy-inspired paint
          scheme, Patrick Davidson&apos;s Hawker Sea Fury flew in an earlier
          livery. These photographs and videos preserve an important chapter in
          the aircraft&apos;s history, capturing the unmistakable sound,
          elegance and raw power of one of the world&apos;s greatest
          piston-engined fighters.
        </p>
      </section>

      <VideoGallery
        title="Classic Videos"
        subtitle="Previous Paint Scheme"
