...
const basePath = "/images/projects/hsbc-svns-trophy-2023";
...
const videoItems = Array.from({ length: 13 }, (_, index) => {
...
const wideImageIndexes = [0, 3, 7, 11, 14];

export default function HSBCProjectClient() {
  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="relative min-h-[72vh] overflow-hidden md:min-h-[88vh]">
        <Image
          src={`${basePath}/bts/13.jpg`}
          alt="Patrick Davidson and Damian Willemse during the HSBC SVNS trophy flight"
          fill
          priority
          sizes="100vw"
        ...
        <div className="relative z-10 flex min-h-[72vh] items-end md:min-h-[88vh]">
          <div className="mx-auto w-full max-w-7xl px-6 pb-14 md:px-10 md:pb-20">
            ...
            <p className="mt-6 max-w-2xl text-base leading-relaxed text-white/75 md:text-xl">
              Patrick Davidson and Damian Willemse delivered the HSBC SVNS
              Cape Town trophy in unmistakable Red Bull style.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="border-y border-white/10 bg-white/[0.03]">
        <div className="mx-auto grid max-w-7xl grid-cols-2 gap-x-6 gap-y-8 px-6 py-10 md:grid-cols-5 md:px-10">
          ...
          <div>
            ...
            <p className="mt-2 text-lg font-bold md:text-xl">2023</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 py-14 md:px-10 md:py-20">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.03] px-4 py-8 md:rounded-3xl md:px-8 md:py-12">
          <div className="mx-auto flex w-full max-w-[605px] justify-center overflow-hidden rounded-2xl bg-white">
            <blockquote
              className="tiktok-embed"
              cite="https://www.tiktok.com/@redbullza/video/7312112188146175265"
              data-video-id="7312112188146175265"
              style={{
                width: "100%",
                maxWidth: "605px",
                minWidth: "325px",
            ...
            >
              <section>
                <a
                  ...
                  title="@redbullza"
                  href="https://www.tiktok.com/@redbullza?refer=embed"
                >
                  @redbullza
                </a>{" "}
                Team work makes the dream work. Pat Davidson made sure the
                HSBC SVNS trophy arrived in style and Damian Willemse made
                sure it was safe.
              </section>
            </blockquote>
          </div>
        ...
        <div className="mt-8 rounded-2xl border border-white/10 bg-white/[0.03] p-7 md:mt-10 md:rounded-3xl md:p-10">
          ...
          <h3 className="mt-3 max-w-4xl text-3xl font-black uppercase leading-tight md:text-5xl">
            From Stellenbosch Flying Club to the Cape Town Stadium
          </h3>

          <div className="mt-6 max-w-4xl space-y-5 text-base leading-7 text-white/65 md:text-lg md:leading-8">
            <p>
              For the 2023 HSBC SVNS Cape Town tournament, Patrick Davidson
              was tasked with delivering the trophy in true Red Bull fashion.
            </p>

            <p>
              Patrick departed from Stellenbosch Flying Club with South
              African rugby star Damian Willemse alongside him in the
              GameBird. Damian&apos;s job was to keep the trophy safe while
              Patrick handled the flying.
            </p>

            <p>
              The flight continued towards Cape Town before passing over the
              rugby stadium, combining aviation, rugby and entertainment in a
              memorable arrival for one of the city&apos;s biggest sporting
              events.
            </p>
          </div>
        </div>
          ...
          {btsImages.map((image, index) => {
            ...
            return (
              <button
                ...
                aria-label={`Open HSBC SVNS behind-the-scenes image ${
                  index + 1
                }`}
              ...
              >
                <Image
                  src={`${basePath}/${image}`}
                  alt={`HSBC SVNS trophy flight behind-the-scenes image ${
                    index + 1
                  }`}
                  fill
                  sizes={
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4 md:gap-4">
            {videoItems.map((video, index) => (
              <button
                ...
                aria-label={`Play behind-the-scenes video ${index + 1}`}
              ...
              >
                <Image
                  src={video.poster}
                  alt={`HSBC SVNS behind-the-scenes video ${index + 1}`}
                  fill
      ...
      {activeImage !== null && (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-label="HSBC SVNS image gallery"
        ...
        >
          ...
          >
            <Image
              ...
              alt={`HSBC SVNS behind-the-scenes image ${activeImage + 1}`}
              fill
              priority
              sizes="100vw"
      ...
      {activeVideo !== null && (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-label="HSBC SVNS video gallery"
